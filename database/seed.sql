...
INSERT INTO users (id, name, email, password_hash, default_location, default_postal_code, preferred_radius_km, theme)
VALUES (1, 'Maja', 'demo@planyourfit.pl', '$2b$12$Qq4pysqdsitv.y8onnNPVeEt0MaQ/6OO04OgDtwX4tF3kqfoupRgC', 'Warszawa', '00-001', 10, 'light')
