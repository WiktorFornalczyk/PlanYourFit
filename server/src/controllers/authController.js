...
const publicUser = (user) => ({ id: user.id, name: user.name, email: user.email, defaultLocation: user.default_location, preferredRadiusKm: user.preferred_radius_km, theme: user.theme });
